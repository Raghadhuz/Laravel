                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="sparkline8-list">
                            <div class="sparkline8-hd">
                                <div class="main-sparkline8-hd text-danger" >
                                    <h1 class="text-success">Basic Table</h1>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="sparkline9-list mt-b-30">
                            ...
                            <div class="sparkline9-graph">
                                <div class="static-table-list">
                                    <table class="table sparkle-table text-danger">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Data</th>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="sparkline10-list mt-b-30">
                            ...
                            <div class="sparkline10-graph">
                                <div class="static-table-list">
                                    <table class="table border-table text-danger">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>First Name</th>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="sparkline12-list mg-b-15">
                            ...
                            <div class="sparkline12-graph">
                                <div class="static-table-list">
                                    <table class="table hover-table text-danger">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>First Name</th>
